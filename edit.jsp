...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>编辑信息-便民租房网</TITLE>
        ...
        <TBODY>
          ...
          background=会员管理中心-沈阳房产网_files/huiyuanindex_10.gif><TABLE border=0 cellSpacing=2 cellPadding=2 width=251 
              ...
              <TBODY><TR>
                ...
                <TR>
                  <TD>·<A 
                  href="person.jsp">管理中心首页</A> </TD>
                </TR>
                <TR>
                  <TD>·<A 
                  href="http://www.024zf.com/huiyuan/updatepassword.aspx">修改密码</A> </TD>
                </TR>
                <TR>
                  <TD>·<A 
                  href="http://www.024zf.com/huiyuan/updatelxfs.aspx">修改联系方式</A> </TD>
                </TR>
                <TR>
...
<c:forEach items="${requestScope.hiList}" var="hi">
                  <TR>
                    <TD width="109" height=27 align=middle bgColor=#d3e5f6 class=font-14>出租价格 <SPAN class=font-hong>*</SPAN></TD>
                  ...
                  onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9.]/g,''))">
                        ...
                        (<span class="STYLE22">为防止欺诈，只能修改价格，如果已发布信息有误，请删除后重新发布，谢谢合作</span>)</TD>
                  </TR>
</c:forEach>
                  <TR>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=950 align=center>
  ...
  <TR>
    ...
    class=style21 style21>房屋租赁网提供普通住宅出租信息发布与查询</SPAN></TD>
  </TR>
  <TR>
