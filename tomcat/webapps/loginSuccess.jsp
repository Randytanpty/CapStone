...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>登陆成功，正在跳转……-便民租房网</TITLE>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=962 align=center>
  ...
  <TR>
    <TD height=328 vAlign=top background=common/image/reg_10.gif><div align="center">
      <p><BR>
        <img src="image/loginSuccess.gif" width="484" height="214" border="0"></p>
      <p><a href="${requestScope.url}">正在跳转到之前页面，请稍后……</a></p>
    </div></TD>
  </TR>
  <TR>
