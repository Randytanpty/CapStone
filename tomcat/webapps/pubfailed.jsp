...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>注册失败了，建议重试-便民租房网</TITLE>
...
<meta http-equiv="refresh"content="2;url=./getMyPub">
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=962 align=center>
  ...
  <TR>
    <TD height=328 vAlign=top background=common/image/reg_10.gif><div align="center">
      <p><BR>
        <img src="image/pubfailed.gif" width="484" height="214" border="0"></p>
      <p><a href="./getMyPub">正在跳转到发布页面，请稍后……</a></p>
    </div></TD>
  </TR>
  <TR>
