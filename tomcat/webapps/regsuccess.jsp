...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>恭喜，注册成功-便民租房网</TITLE>
...
<meta http-equiv="refresh"content="3;url=./getMyPub">
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=962 align=center>
  ...
  <TR>
    <TD height=328 vAlign=top background=common/image/reg_10.gif><div align="center">
      <p><BR>
        <img src="image/success.gif" width="484" height="214" border="0"></p>
      <p><a href="./getMyPub">正在跳转到个人中心，请稍后……</a></p>
    </div></TD>
  </TR>
  <TR>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=950 align=center>
  ...
  <TR>
    <TD height=40 align=middle>  </TD></TR></TBODY></TABLE>
</FORM>
