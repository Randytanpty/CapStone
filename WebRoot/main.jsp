...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>便民房屋租赁-便民租房网</TITLE>
  ...
  <TABLE border=0 width="100%">
    <TBODY>
      ...
      height=28>
            ...
            align=center>便民租房网客服QQ：252878950</TD>
              </TR>
            </TBODY>
        </TABLE></TD>
      </TR>
    ...
    <TBODY>
      ...
      height=28>
          <TBODY>
            ...
            style="DISPLAY: none" id=Top1_1_divyi></SPAN></TD>
              <TD colSpan=2 
            align=right>便民租房网客服电话：024-88888888（8:00-17:00）　88888888（夜班）　客服QQ：252878950</TD>
            </TR>
          </TBODY>
        </TABLE></TD>
      </TR>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=950 align=center>
  ...
  <TR>
    <TD><c:if test="${!empty requestScope.hiList}">
      <div align="center">共<font color="blue">${requestScope.rec }</font>条记录
            ...
            <c:if test="${requestScope.pageNum ne 1}"> <a href="./index.jsp?pageNum=1">首页</a> <a
								href="./index.jsp?page=${requestScope.pageNum-1}">上一页</a> </c:if>
            ...
            <c:if test="${requestScope.pageNum ne requestScope.pageCount}"> <a
								href="./index.jsp?pageNum=${requestScope.pageNum + 1}">下一页</a> <a
								href="./index.jsp?pageNum=${requestScope.pageCount}">末页</a></c:if>
      </div>
</c:if></TD></TR>
  <TR>
    <TD>
  ...
  <TR>
    ...
    class=style2>房屋租赁网提供普通住宅出租信息发布与查询</SPAN></TD>
  </TR>
  <TR>
  ...
  <TR>
    <TD height=26 align=middle>Copyright181.cc All Rights Reserved<SPAN 
      class=black>&nbsp;&nbsp; </SPAN>ICP证：辽B-2-4-20090106</TD></TR>
  <TR>
