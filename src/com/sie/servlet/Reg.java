...
public class Reg extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(yanzhengma!=rand){
			response.getWriter().print("<script>alert('验证码错误，请重新填写！');window.navigate('./reg.jsp');</script>");
		}
		...
		//System.out.println(usrAccount+usrPassword+repassword+usrName+usrSex+usrPhone+usrAddress+usrEmail);
		Usr usr=new Usr();
