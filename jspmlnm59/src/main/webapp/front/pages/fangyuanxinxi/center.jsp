					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="fangdongzhanghao" id="fangdongzhanghao" placeholder="房东账号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">房东姓名</label>
							<div class="layui-input-block">
								<input type="text" name="fangdongxingming" id="fangdongxingming" placeholder="房东姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dianhua" id="dianhua" placeholder="电话" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">是否装修</label>
							<div class="layui-input-block">
								<select name="shifouzhuangxiu" id="shifouzhuangxiu">
							...
							<div class="layui-input-block">
								<input type="text" name="xiangxidizhi" id="xiangxidizhi" placeholder="详细地址" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="chaoxiang" id="chaoxiang" placeholder="朝向" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">交通</label>
							<div class="layui-input-block">
								<input type="text" name="jiaotong" id="jiaotong" placeholder="交通" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">层数</label>
							<div class="layui-input-block">
								<input type="text" name="cengshu" id="cengshu" placeholder="层数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">格局</label>
							<div class="layui-input-block">
								<input type="text" name="geju" id="geju" placeholder="格局" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">房龄</label>
							<div class="layui-input-block">
								<input type="text" name="fangling" id="fangling" placeholder="房龄" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
