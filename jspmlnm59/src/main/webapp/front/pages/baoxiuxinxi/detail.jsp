				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>报修编号：</span>
							<span class="desc">
								{{detail.baoxiubianhao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>设备名称：</span>
							<span class="desc">
								{{detail.shebeimingcheng}}
							</span>
						</div>
																								<div class="detail-item">
							<span>用户账号：</span>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.qingkuangshuoming"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`baoxiuxinxi`);
