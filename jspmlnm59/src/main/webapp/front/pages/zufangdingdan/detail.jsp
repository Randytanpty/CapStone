				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>租房合同：</span>
							<span class="desc">
								<a download="zufanghetong" :href="detail.zufanghetong">点击下载</a>
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('zufangdingdan','报修')" @click="onAcrossTap('baoxiuxinxi')" type="button" class="layui-btn">
								报修
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`zufangdingdan`);
