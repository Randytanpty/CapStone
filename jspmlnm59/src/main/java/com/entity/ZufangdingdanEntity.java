...
public class ZufangdingdanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ZufangdingdanEntity() {
		
	}
	
	public ZufangdingdanEntity(T t) {
		try {
	 ...
	 * 设置：租房合同
	 */
	public void setZufanghetong(String zufanghetong) {
		this.zufanghetong = zufanghetong;
	}
	/**
	 * 获取：租房合同
	 */
	public String getZufanghetong() {
		return zufanghetong;
	}
	/**
	 * 设置：签订时间
